...
- **Local Models**: [Ramalama](https://github.com/containers/ramalama) manages models as containers and serves an OpenAI-compatible endpoint:
...
Then in `goose configure`, select **Ollama** and set `OLLAMA_HOST` to `http://localhost:8080`.
